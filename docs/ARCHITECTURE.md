...
- `workflow.ts`: defines role-isolated workflows, human Gate loops, event checkpoints, and Task Contract projection
...
- persists the current workflow checkpoint with the Task Context;
